...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiZGVuLTIxIiwiYSI6ImNrdjZvb3k3NjJ6NmsybnF3ZGdyYmwzZHAifQ.2gFmnOz8sk8Gh2tkjp-hvw";
  var map = new mapboxgl.Map({
    container: "map",
    // put mapElement to id=map
...
var showAlert = function showAlert(type, msg) {
  ...
  document.querySelector("body").insertAdjacentHTML("afterbegin", markup); // remove all alert after 5sec
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "You are logged in successfully"); // reload & redirect ot home page
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault(); //change btn text until data password updating will processed
